...
## [0.12.0](https://github.com/kainosaur/bevy_mod_scripting/compare/v0.11.1...v0.12.0) - 2025-04-13
...
- add option to emit response event on each callback  & `RunScriptCallback` command for "once-off" callbacks ([#403](https://github.com/kainosaur/bevy_mod_scripting/pull/403))

### Fixed

- `lua54` feature being forced ([#413](https://github.com/kainosaur/bevy_mod_scripting/pull/413))
...
- add script loading benchmark ([#411](https://github.com/kainosaur/bevy_mod_scripting/pull/411))
- refactor `ReflectReference` internally ([#406](https://github.com/kainosaur/bevy_mod_scripting/pull/406))
- reduces size of `ScriptValue` to 64 bytes, moves some dynamic function methods into function info ([#404](https://github.com/kainosaur/bevy_mod_scripting/pull/404))
